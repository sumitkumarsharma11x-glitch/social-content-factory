...
- Use this flow inside the body: HOOK/QUESTION → CURIOSITY → REVEAL → SIMPLE EXPLANATION → EXAMPLE/CONTEXT → optional WEBSITE APPROACH. The cta field is separate from body, so NEVER put the CTA inside body.
- CRITICAL OUTPUT BOUNDARY: body must be creator-ready natural copy, not a labeled strategy template. NEVER print labels such as Hook:, Hindi Voice-over:, Voice-over:, Visual:, Visual/Presentation:, Takeaway:, CTA:, Explanation:, or Angle: inside body. Do not serialize internal strategy fields into the body. If a visual cue is genuinely useful, express it naturally as part of the copy rather than as a strategy label.
